...
export default function Hero() {
  return (
    <header className="px-6 lg:px-14 pt-8 border-b border-b-secondary-100 relative overflow-hidden">
      <>
        <Star className="top-20 left-28" color="white" />
        <Star className="top-32 right-9 lg:right-[50%]" color="gray" />
        <Star
